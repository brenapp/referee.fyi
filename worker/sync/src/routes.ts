...
import * as api_meta_location from "./api/sync/meta/location";
import * as api_user from "./api/sync/user";
import * as api_$sku_invitation from "./api/sync/$sku/invitation";
import * as api_$sku_invite_put from "./api/sync/$sku/invite/put";
import * as api_$sku_invite_delete from "./api/sync/$sku/invite/delete";
import * as api_$sku_list from "./api/sync/$sku/list";
import * as api_$sku_request_put from "./api/sync/$sku/request/put";
import * as api_$sku_request_get from "./api/sync/$sku/request/get";
import * as api_$sku_create from "./api/sync/$sku/create";
import * as api_$sku_accept from "./api/sync/$sku/accept";
import * as api_$sku_asset_upload_url from "./api/sync/$sku/asset/upload_url";
import * as api_$sku_asset_url from "./api/sync/$sku/asset/url";
import * as api_$sku_asset_preview_url from "./api/sync/$sku/asset/preview_url";
import * as api_$sku_incident_put from "./api/sync/$sku/incident/put";
import * as api_$sku_incident_patch from "./api/sync/$sku/incident/patch";
import * as api_$sku_incident_delete from "./api/sync/$sku/incident/delete";
import * as api_$sku_data from "./api/sync/$sku/data";
import * as api_$sku_join from "./api/sync/$sku/join";
