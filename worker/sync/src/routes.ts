...
import * as api_integration_v1_$sku_scratchpad from "./api/integration/v1/$sku/scratchpad";
...
const routes = app
  ...
  .openapi(
    api_integration_v1_$sku_scratchpad.route,
    api_integration_v1_$sku_scratchpad.handler
  )
