/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env production` (hash: ec0652ba46a389ee8e0204783646ab57)
// Runtime types generated with workerd@1.20251118.0 2025-08-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ShareInstance";
	}
	interface Env {
		WRANGLER_ENVIRONMENT: "development" | "staging" | "production";
		CLOUDFLARE_EMAIL: "brendan@bren.app";
		CLOUDFLARE_IMAGES_ACCOUNT_ID: "f9b9e088206092e25d77f0def608c799";
		INCIDENTS: DurableObjectNamespace<import("./src/index").ShareInstance>;
		DB: D1Database;
		CLOUDFLARE_API_KEY: SecretsStoreSecret;
		CLOUDFLARE_IMAGES_SIGNATURE_TOKEN: SecretsStoreSecret;
		CLOUDFLARE_IMAGES_WEBHOOK_SECRET: SecretsStoreSecret;
		ROBOTEVENTS_TOKEN: SecretsStoreSecret;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WRANGLER_ENVIRONMENT" | "CLOUDFLARE_EMAIL" | "CLOUDFLARE_IMAGES_ACCOUNT_ID">> {}
}
