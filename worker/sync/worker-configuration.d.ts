/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env staging` (hash: 11a50a54f0b755777499d50cb14af52f)
...
declare namespace Cloudflare {
	interface Env {
		...
		CLOUDFLARE_IMAGES_WEBHOOK_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WRANGLER_ENVIRONMENT" | "CLOUDFLARE_EMAIL" | "CLOUDFLARE_IMAGES_ACCOUNT_ID" | "CLOUDFLARE_API_KEY" | "CLOUDFLARE_IMAGES_WEBHOOK_SECRET" | "CLOUDFLARE_IMAGES_SIGNATURE_TOKEN" | "ROBOTEVENTS_TOKEN">> {}
}
